...
function About() {
  ...
  return (
    <section ref={targetRef} className="relative bg-neutral-900 text-white h-[300vh]">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        <motion.div style={{ x }} className="flex">
          
          <div className="flex items-center justify-center ml-12 w-[50vw] shrink-0">
            <div className="flex items-center justify-center">
              <div className="bg-neutral-800/80 border border-neutral-700 rounded-3xl p-10 max-w-md text-center shadow-lg">
                <h2 className="text-3xl font-bold text-white mb-2">About Me</h2>
                <h3 className="text-lg text-yellow-400 font-semibold mb-4">Who I Am</h3>
                <p className="text-gray-300 text-sm">
                  A brief look into my professional journey, skills, and educational background. Scroll to explore more.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Skills with vertical line */}
          <div className="flex flex-grow items-start justify-center w-[50vw] shrink-0 px-4">
            <div className="bg-neutral-800/90 backdrop-blur-sm rounded-3xl p-12 w-full max-w-4xl border-2 border-neutral-700">
          ...
          {/* Education Section */}
          <div className="flex items-center justify-center w-[50vw] shrink-0 px-8">
            <div className="bg-neutral-800/90 backdrop-blur-sm rounded-3xl p-12 w-full max-w-2xl border-2 border-neutral-700">
              <div className="flex items-center gap-3 mb-8">
                <div className="p-3 bg-yellow-400/10 rounded-xl">
          ...
          {/* Blog Header Section (styled like intro) */}
          <div className="flex items-center justify-center w-[50vw] shrink-0 px-8">
            <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-2 border-neutral-700 rounded-3xl p-12 max-w-2xl text-center shadow-xl transform hover:scale-[1.02] transition-all duration-300">
              <h2 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent mb-6">
                My Writings
              </h2>
          ...
          {/* Blog Cards Section with Button */}
          <div className="flex items-center w-[50vw] shrink-0 pl-8 pr-24">
            <div className="flex gap-8 w-full ">
              {blogs?.map((blog) => (
                <div key={blog.id} className="flex-shrink-0 w-[400px]">
                  <BlogCard blog={blog} />
                </div>
              ))}
              
              {/* Read More CTA Card */}
              <div className="flex-shrink-0 w-[400px] flex items-center justify-center pr-8">
                <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-2 border-neutral-700 rounded-2xl p-8 w-full h-[320px] flex flex-col items-center justify-center text-center space-y-6 hover:border-yellow-400 transition-all duration-300">
